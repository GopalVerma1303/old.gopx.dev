...
export function BlogHeader() {
  return (
    <div className="max-w-screen-lg mx-auto pt-4 pb-4  border-gray-400 border-opacity-20">
      ...
      <p className="text-center font-space-grotesk font-roboto font-bold uppercase text-xl">Blogs</p>
      <h1>
        <span className="font-bold font-serif leading-tight lg:text-5xl">Read my technical blogs for insights on various tech topics.</span>
      </h1>
    </div>
  )
}
